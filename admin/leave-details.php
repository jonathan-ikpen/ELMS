...
<td colspan="5">
    <?php 
    // Show HOD approval status using HODApprovalStatus
    if(isset($result->HODApprovalStatus)) {
        if($result->HODApprovalStatus==1) {
            echo '<span style="color: green">Approved by HOD</span>';
        } elseif($result->HODApprovalStatus==2) {
            echo '<span style="color: red">Rejected by HOD</span>';
        } else {
            echo '<span style="color: blue">Pending HOD Approval</span>';
        }
    } else {
        echo '<span style="color: blue">Pending HOD Approval</span>';
    }
...
<td colspan="5"><?php
if(isset($result->HODRemark) && $result->HODRemark!=""){
  echo htmlentities($result->HODRemark);
} else {
  echo "Pending HOD Action";
}
?></td>
</tr>
<tr>
...
<td colspan="5"><?php
if(isset($result->HODActionDate) && $result->HODActionDate!=""){
  echo htmlentities($result->HODActionDate);
} else {
  echo "NA";
}
?></td>
...
<tr>
 <td colspan="6">
  ...
  <form name="adminaction" method="post" id="adminactionform">
