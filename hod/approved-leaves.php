...
$sql = "SELECT tblleaves.id as lid, tblemployees.FirstName, tblemployees.LastName, tblemployees.EmpId, tblleaves.LeaveType, tblleaves.PostingDate, tblleaves.Status, tblleaves.HODRemark, tblleaves.HODActionDate 
        ...
        WHERE tblemployees.Department = :dept AND tblleaves.HODApprovalStatus = 1 
        ORDER BY tblleaves.id DESC";
$query = $dbh->prepare($sql);
$query->bindParam(':dept', $hodDept, PDO::PARAM_STR);
$query->execute();
$resultsApproved = $query->fetchAll(PDO::FETCH_OBJ);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <?php include('includes/header.php');?>
        ...
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title">Leave Requests You Approved</div>
                </div>
                <div class="col s12 m12 l12">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title">Approved Leave Requests for <?php echo htmlentities($hodDept);?> Department</span>
                            <table id="example" class="display responsive-table ">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach($resultsApproved as $result) { ?>
                                    <tr>
