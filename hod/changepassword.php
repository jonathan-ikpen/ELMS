...
$username=$_SESSION['hodlogin'];
    $sql ="SELECT Password FROM hod WHERE UserName=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tblhod set Password=:newpassword where EmailId=:username";
...
<div class="input-field col s12">
<button type="submit" name="change" class="waves-effect waves-light btn indigo m-b-xs">Change</button>
</div>
                                        </div>
                                    </form>
                                </div>
