...
$query->execute();
$resultsPending = $query->fetchAll(PDO::FETCH_OBJ);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>HOD | Pending Leaves</title>
                ...
                <div class="col s12 m12 l12">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title">Pending Leave Requests for <?php echo htmlentities($hodDept);?> Department</span>
                            <table id="example" class="display responsive-table ">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach($resultsPending as $result) { ?>
                                    <tr>
                                        ...
                                        <td><a href="leave-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="waves-effect waves-light btn blue m-b-xs">View/Approve</a></td>
                                    </tr>
                                <?php $cnt++; } ?>
                                </tbody>
                            </table>
