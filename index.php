        ...
        <div class="mn-content fixed-sidebar">
            <header class="mn-header navbar-fixed">
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3" style="width: 100%;  white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">      
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    ...
                    <li class="no-padding"><a class="waves-effect waves-grey" href="admin/"><i class="material-icons">account_box</i>Registrar/HR Login</a></li>
                
                </ul>
          <div class="footer">
                    <p class="copyright">PTI ELMS ©</p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="display: flex; text-align: center; flex-direction: column; justify-content: center; align-items: center; width: 100%;">
                            <img src="assets/images/pti_logo_bg.jpeg" width="100" />
